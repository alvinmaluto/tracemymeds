(function(j, h, c, g, d, k, f) { /*! Jssor */
    ...
    var b = j.$Jssor$ = new function() {
        ...
        function Ib() {
            if (!O) {
                O = {
                    Ze: "ontouchstart" in j || "createTouch" in h
                };
                var a;
    ...
    var m = {
        ...
        q = j.$JssorSlideshowFormations$ = new function() {
            ...
            h.$FormationStraight = function(f) {
                for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.ac, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++)
                    for (a = 0; a < d; a++) {
                        switch (s) {
                            case j:
                                c = h - (a * e + (q - b));
            ...
            a.fe = function(c, b) {
                ...
                if (!a.fc[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++)
                        for (var e = 0; e < a.$Rows; e++) a.fc[f][e + "," + d] = {
                            $Top: e * b,
                            $Right: d * c + c,
                            $Bottom: e * b + b,
                            $Left: d * c
