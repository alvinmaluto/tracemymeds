...
! function(e, t, n) {
    ...
    function a() {
        ...
        for (var f in s)
            if (s.hasOwnProperty(f)) {
                if (e = [], t = s[f], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
    ...
    f || ! function(e, t) {
        ...
        function p(e) {
            ...
            return !j || e.printShived ? e : ("undefined" == typeof s[x] && s.add(x), c.attachEvent("onbeforeprint", function() {
                t();
                for (var o, i, s, c = e.styleSheets, l = [], u = c.length, m = Array(u); u--;) m[u] = c[u];
                for (; s = m.pop();)
    ...
    }("undefined" != typeof e ? e : this, t), a(), o(i), delete c.addTest, delete c.addAsyncTest;
